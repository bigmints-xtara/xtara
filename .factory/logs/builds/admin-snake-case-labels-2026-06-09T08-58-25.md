# Build: admin-snake-case-labels

**Date**: 2026-06-09T08:58:25.122Z
**Story**: /home/bigmints/projects/xtara/xtara-web/.factory/stories/features/admin-snake-case-labels.yaml
**CLI**: pi
**Files**: 330

## Summary
Delivered snake_case to Title Case formatting for Admin UI labels. Implemented formatSnakeCaseToTitleCase utility in src/lib/utils.ts, applied to domain filter options in AdminMasterDetail.tsx and career cluster/relevance chips in StoryEditor.tsx. Underlying data remains snake_case — only display is transformed. TypeScript compilation verified with 0 errors.
