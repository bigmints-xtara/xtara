# Build: dream-careers-management

**Date**: 2026-06-12T09:40:00.499Z
**Story**: /home/bigmints/projects/xtara/xtara-web/.factory/stories/features/dream-careers-management.yaml
**CLI**: pi
**Files**: 375

## Summary
Created src/lib/admin/configs/dreamCareersConfig.ts with AdminConfig<AdminCareerPath> following the established admin CMS pattern. Includes all required methods: createEmpty, getId, getTitle, getSubtitle, getStatus, getDomain, getSearchText, availableStatuses, getAvailableDomains, toFirestore, fromFirestore. Collection name is 'career_paths'.
